...
export const openApiDocument={
 ...
 "/api/admin/resend-test":{post:{tags:["Monitoring"],summary:"Send a Resend verification email to the authenticated administrator",description:"Uses the server-only RESEND_API_KEY and RESEND_FROM_EMAIL environment variables. With onboarding@resend.dev, the recipient must normally match the Resend account email.",security:bearer,responses}},
